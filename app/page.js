  ...
  useEffect(() => {
    ...
    const initScripts = () => {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            modal.onclick = closeGalleryPreview;

            // Attach clicks to gallery cards
            document.querySelectorAll('.gallery-card').forEach(card => {
                card.addEventListener('click', () => {
                    const imgSrc = card.querySelector('img').src;
                    openGalleryPreview(imgSrc);
                });
            });
            ...
            <nav className="navbar navbar-expand-lg">
                <div className="container-fluid px-4">
                    <a className="navbar-brand" href="index.html">
                        <img src="images/ieee-images/IEEE_logo.png" alt="IEEE PES Kerala" fetchPriority="high"
                            decoding="async" width="120" height="40" />
                    </a>
                        ...
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li><a href="about.html" className="dropdown-item">About IEEE PES</a></li>
                                    <li><a href="vision-mission.html" className="dropdown-item">Vision & Mission</a></li>
                                    <li><a href="history.html" className="dropdown-item">History</a></li>
                                </ul>
                            </li>
                            <li className="nav-item dropdown">
                                <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Execom</a>
                                <ul className="dropdown-menu">
                                    <li><a href="execom.html" className="dropdown-item">Executive Committee</a></li>
                                    <li><a href="past-execom.html" className="dropdown-item">Past Execom</a></li>
                                </ul>
                            </li>
                            <li className="nav-item dropdown">
                                <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Activities</a>
                                <ul className="dropdown-menu">
                                    <li><a href="student-branches.html" className="dropdown-item">Student Branch
                                            Chapters</a></li>
                                    <li><a href="initiatives.html" className="dropdown-item">Initiatives</a></li>
                                    <li><a href="awards.html" className="dropdown-item">Awards</a></li>
                                </ul>
                            </li>
                            <li className="nav-item dropdown">
                                <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Events</a>
                                <ul className="dropdown-menu">
                                    <li><a href="upcoming-events.html" className="dropdown-item">Upcoming Events</a></li>
                                    <li><a href="past-events.html" className="dropdown-item">Past Events</a></li>
                                </ul>
                            </li>
                            <li className="nav-item dropdown">
                                <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Membership</a>
                                <ul className="dropdown-menu">
                                    <li><a href="membership-benefits.html" className="dropdown-item">Membership Benefits</a>
                                    </li>
                            ...
                            <li className="nav-item">
                                <a href="newsletters.html" className="nav-link">Newsletters</a>
                            </li>
                            <li className="nav-item">
            ...
            <div className="hero-island" data-aos="zoom-in" data-aos-duration="800">
                ...
                <div className="hero-container-inner">
                    ...
                    <div className="hero-buttons" data-aos="fade-up" data-aos-delay="500">
                        <a href="about.html" className="btn-glass btn-glass-primary">
                            Our Legacy <i className="fa-solid fa-arrow-right"></i>
                        </a>
                        <a href="upcoming-events.html" className="btn-glass">
                            ...
                            <div className="swiper update-swiper upcoming-update-swiper">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/Events/agm2026.png" alt="AGM 2026"
                                    ...
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/Events/pesgre_event.png" alt="PESGRE"
                                                    loading="lazy" decoding="async" width="640" height="640" />
                                            </div>
                                            <div className="swiper-update-body">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/Events/smartgrid_event.png" alt="Workshop"
                                                    loading="lazy" decoding="async" width="640" height="640" />
                                            </div>
                                            <div className="swiper-update-body">
                            ...
                            <div className="swiper update-swiper recent-update-swiper">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/recent_1.png" alt="Workshop" loading="lazy"
                                    ...
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/recent_2.png" alt="Seminar" loading="lazy"
                                                    decoding="async" width="640" height="640" />
                                            </div>
                                            <div className="swiper-update-body">
                    ...
                    <div className="col-12">
                        <div className="update-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div className="view-all-announcements">
                                <a href="announcements.html" className="btn-view-all">
                ...
                <div className="row align-items-center g-5">
                    <div className="col-lg-6" data-aos="fade-right">
                        <div className="about-image-wrapper">
                            <img src="images/ieee-images/about_modern.png" alt="Engineering Innovation" loading="lazy"
                    ...
                    <div className="col-lg-6 about-content" data-aos="fade-left">
                        ...
                        <div className="d-flex gap-4 flex-wrap">
                            <a href="about.html" className="btn-base-color">
                                Our Story <i className="fa-solid fa-arrow-right ms-2"></i>
                            </a>
                            <a href="student-branches.html"
                        ...
                        <div className="chair-message" data-aos="fade-up">
                            ...
                            <div className="chair-info">
                                <div className="chair-avatar">
                                    <img src="images/ieee-images/BobyPhilp.jpeg" alt="Dr. Boby Philip" loading="lazy"
                            ...
                            <div className="swiper flagship-swiper akpessc-swiper">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/Flagships/akpessc_flagship_1770434008791.png"
                                                    alt="AKPESSC" loading="lazy" decoding="async" width="640"
                                                    height="480" />
                                            </div>
                                            <div className="swiper-update-body">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/Gallery/gallery_1.png"
                                                    alt="AKPESSC Highlights" loading="lazy" decoding="async" width="640"
                                                    height="480" />
                                            </div>
                                            <div className="swiper-update-body">
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card mb-3">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/Flagships/wow_flagship_1770434024340.png"
                                                    alt="WOW" loading="lazy" decoding="async" width="640" height="480" />
                                            </div>
                                            <div className="swiper-update-body">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card mb-3">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/Flagships/intellect_flagship_1770434044351.png"
                                                    alt="Intellect" loading="lazy" decoding="async" width="640"
                                                    height="480" />
                                            </div>
                                            <div className="swiper-update-body">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="swiper-update-card mb-3">
                                            <div className="swiper-update-img">
                                                <img src="images/ieee-images/recent_1.png" alt="PES Day Celebrations"
            ...
            <div className="container-fluid px-md-5 px-4">
                <div className="row mb-5 align-items-end">
                    ...
                    <div className="col-lg-4 text-lg-end mt-3 mt-lg-0" data-aos="fade-left">
                        <a href="upcoming-events.html" className="btn btn-outline-primary px-5 py-3 rounded-pill fw-700"
                ...
                <div className="row g-4">
                    <div className="col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
                        <div className="event-card">
                            <div className="event-card-image">
                                <img src="images/ieee-images/Events/agm2026.png" alt="Annual General Meeting 2026"
                                    loading="lazy" decoding="async" width="640" height="640" />
                            </div>
                    ...
                    <div className="col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
                        <div className="event-card">
                            <div className="event-card-image">
                                <img src="images/ieee-images/Events/pesday_event.png" alt="IEEE PES Day" loading="lazy"
                                    decoding="async" width="640" height="640" />
                            </div>
                            <div className="event-card-body">
                                <div>
                    ...
                    <div className="col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
                        <div className="event-card">
                            <div className="event-card-image">
                                <img src="images/ieee-images/Events/smartgrid_event.png" alt="Smart Grid Workshop"
                                    loading="lazy" decoding="async" width="640" height="640" />
                            </div>
                            <div className="event-card-body">
                                <div>
                    ...
                    <div className="col-md-6 col-lg-3 d-md-none d-lg-block" data-aos="zoom-in" data-aos-delay="400">
                        <div className="event-card">
                            <div className="event-card-image">
                                <img src="images/ieee-images/Events/renewable_event.png" alt="Renewable Energy Webinar"
                                    loading="lazy" decoding="async" width="640" height="640" />
                            </div>
                            <div className="event-card-body">
                                <div>
        ...
        <section className="gallery-section section-padding">
            <div className="container-fluid px-md-5 px-4">
                <div className="row mb-5 align-items-end">
                    ...
                    <div className="col-lg-4 text-lg-end mt-3 mt-lg-0" data-aos="fade-left">
                        <a href="gallery.html" className="btn btn-outline-primary px-5 py-3 rounded-pill fw-700">
                ...
                <div className="swiper gallery-swiper" data-aos="fade-up">
                    <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide">
                            <div className="gallery-card">
                                <div className="gallery-image-wrapper">
                                    <img src="images/ieee-images/Gallery/gallery_1.png" alt="Technical Talk"
                        ...
                        <div className="swiper-slide">
                            <div className="gallery-card">
                                <div className="gallery-image-wrapper">
                                    <img src="images/ieee-images/Gallery/gallery_2.png" alt="Workshop" loading="lazy"
                        ...
                        <div className="swiper-slide">
                            <div className="gallery-card">
                                <div className="gallery-image-wrapper">
                                    <img src="images/ieee-images/Gallery/gallery_3.png" alt="Volunteer Meet"
                                        loading="lazy" decoding="async" width="400" height="400" />
                                </div>
                                <div className="gallery-caption">
                        ...
                        <div className="swiper-slide">
                            <div className="gallery-card">
                                <div className="gallery-image-wrapper">
                                    <img src="images/ieee-images/Gallery/gallery_4.png" alt="Industrial Visit"
                                        loading="lazy" decoding="async" width="400" height="400" />
                                </div>
                                <div className="gallery-caption">
                        ...
                        <div className="swiper-slide">
                            <div className="gallery-card">
                                <div className="gallery-image-wrapper">
                                    <img src="images/ieee-images/Gallery/gallery_1.png" alt="Seminar" loading="lazy"
                                        decoding="async" width="400" height="400" />
                                </div>
                                <div className="gallery-caption">
            ...
            <div className="row g-5">
                <div className="col-lg-4 col-md-6">
                    <div className="footer-brand">
                        <img src="images/ieee-images/PESKC.png" alt="IEEE PES Kerala" />
                ...
                <div className="col-lg-2 col-md-6 col-6">
                    ...
                    <ul className="footer-links">
                        ...
                        <li><a href="student-branches.html">Student Branches</a></li>
